...
TEST_CASE("Verify else if conversion of numerical Grade to letter", "Else If Statement") 
{	
...
TEST_CASE("Verify switch conversion of numerical Grade to letter", "Using Switch") 
{	
